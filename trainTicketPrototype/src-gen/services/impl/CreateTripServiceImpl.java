...
public class CreateTripServiceImpl implements CreateTripService, Serializable {
	...
	public boolean check(String accoutId) throws PreconditionException, PostconditionException, ThirdPartyServiceException {
	...
	@SuppressWarnings("unchecked")
	public boolean buyTicket(String routeId, String ticketId) throws PreconditionException, PostconditionException, ThirdPartyServiceException {
		...
		/* check precondition */
		if (StandardOPs.oclIsundefined(route) == false && StandardOPs.oclIsundefined(ticket) == true) 
		{ 
			/* Logic here */
			Ticket tic = null;
		...
		//string parameters: [routeId, ticketId] 
