...
<table>
    ...
    <tr>
        <td><b>Operation:</b></td>
    <td><ul><li><a href="#OPbuyTicket">buyTicket</a></li><li><a href="#OPsaveOrder">saveOrder</a></li><li><a href="#OPpay">pay</a></li></ul></td>
    </tr>
<tr>
    ...
    <tr>
        <td><span name ="BuyTicketServiceCurrentAccoutId">CurrentAccoutId</span></td>
        <td>the type of CurrentAccoutId is String</td>
                    </tr>
    <tr>
...
<table>
    ...
    <tr>
        <td><b>Operation:</b></td>
    <td><ul><li><a href="#OPupdateTicket">updateTicket</a></li><li><a href="#OPupdateOrder">updateOrder</a></li><li><a href="#OPpayDifference">payDifference</a></li></ul></td>
    </tr>
<tr>
            <td><b>Temporary Variable</b></td>
            <td><b>Variable Description</b></td>
...
<table>
    ...
    <tr>
        ...
        <td></td>
        <td>
        <p><a href="#OPbuyTicket">buyTicket</a></p><p><a href="#OPsaveOrder">saveOrder</a></p><p><a href="#OPpay">pay</a></p>
        </td>
    </tr>
    <tr>
        <td>UC2</td>
    ...
    <tr>
        ...
        <td></td>
        <td>
        <p><a href="#OPupdateTicket">updateTicket</a></p><p><a href="#OPupdateOrder">updateOrder</a></p><p><a href="#OPpayDifference">payDifference</a></p>
        </td>
    </tr>
    <tr>
        <td>UC11</td>
...
<table>
    ...
    <td><p>1. Passenger clicks to execute the operation <a href="#OPbuyTicket">buyTicket</a>, with entering accoutId, routeId, seatId, price, ticketId</p><p>2. Passenger clicks to execute the operation <a href="#OPsaveOrder">saveOrder</a>, with entering orderId, boughtTime</p><p>3. Passenger clicks to execute the operation <a href="#OPpay">pay</a></p></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        <td><b>Basic Path:</b></td>
    <td><p>1. Passenger clicks to execute the operation <a href="#OPupdateTicket">updateTicket</a>, with entering accoutId, ticketId, newRouteId, price, seatId</p><p>2. Passenger clicks to execute the operation <a href="#OPupdateOrder">updateOrder</a>, with entering time</p><p>3. Passenger clicks to execute the operation <a href="#OPpayDifference">payDifference</a></p><p>4. Passenger clicks to execute the operation <a href="#OPupdateTicket">updateTicket</a>, with entering accoutId, ticketId, newRouteId, price, seatId</p><p>5. Passenger clicks to execute the operation <a href="#OPupdateOrder">updateOrder</a>, with entering time</p></td>
    </tr>
    <tr>
        <td><b>Alternative Path:</b></td>
        <td></td>
...
<td><p>1. <i>route</i> is the object <i>rou</i> in the instance set of class <a href="#CLASSRoute">Route</a>. <i>rou</i> represents an object of class <a href="#CLASSRoute">Route</a>, and <i>rou</i> meets:</p><p>  The attribute <i>RouteId</i> of the object <i>rou</i> is equal to <i>routeid</i></p><p>2. <i>train</i> is the object <i>tra</i> in the instance set of class <a href="#CLASSTrain">Train</a>. <i>tra</i> represents an object of class <a href="#CLASSTrain">Train</a>, and <i>tra</i> meets:</p><p>  The attribute <i>TrainId</i> of the object <i>tra</i> is equal to <i>trainid</i></p></td>
    </tr>
    <tr>
<td><b>Preconditions:</b></td>
...
<tr>
            <td><b>Definition:</b></td>
<td><p><i>route</i> is the object <i>rou</i> in the instance set of class <a href="#CLASSRoute">Route</a>. <i>rou</i> represents an object of class <a href="#CLASSRoute">Route</a>, and <i>rou</i> meets:</p><p>  The attribute <i>RouteId</i> of the object <i>rou</i> is equal to <i>routeid</i></p></td>
    </tr>
    <tr>
<td><b>Preconditions:</b></td>
...
<tr>
            <td><b>Definition:</b></td>
<td><p><i>train</i> is the object <i>tra</i> in the instance set of class <a href="#CLASSTrain">Train</a>. <i>tra</i> represents an object of class <a href="#CLASSTrain">Train</a>, and <i>tra</i> meets:</p><p>  The attribute <i>TrainId</i> of the object <i>tra</i> is equal to <i>trainid</i></p></td>
    </tr>
    <tr>
<td><b>Preconditions:</b></td>
...
<tr>
            <td><b>Definition:</b></td>
<td><p><i>ticket</i> is the object <i>tic</i> in the instance set of class <a href="#CLASSTicket">Ticket</a>. <i>tic</i> represents an object of class <a href="#CLASSTicket">Ticket</a>, and <i>tic</i> meets:</p><p>  The attribute <i>TicketId</i> of the object <i>tic</i> is equal to <i>ticketid</i></p></td>
    </tr>
    <tr>
<td><b>Preconditions:</b></td>
...
<tr>
            <td><b>Definition:</b></td>
<td><p><i>order</i> is the object <i>ord</i> in the instance set of class <a href="#CLASSOrder">Order</a>. <i>ord</i> represents an object of class <a href="#CLASSOrder">Order</a>, and <i>ord</i> meets:</p><p>  The attribute <i>OrderId</i> of the object <i>ord</i> is equal to <i>orderid</i></p></td>
    </tr>
    <tr>
<td><b>Preconditions:</b></td>
...
<tr>
            <td><b>Definition:</b></td>
<td><p><i>accout</i> is the object <i>acc</i> in the instance set of class <a href="#CLASSAccout">Accout</a>. <i>acc</i> represents an object of class <a href="#CLASSAccout">Accout</a>, and <i>acc</i> meets:</p><p>  The attribute <i>AccoutId</i> of the object <i>acc</i> is equal to <i>accoutid</i></p></td>
    </tr>
    <tr>
<td><b>Preconditions:</b></td>
...
<tr>
            <td><b>Definition:</b></td>
<td><p><i>seat</i> is the object <i>sea</i> in the instance set of class <a href="#CLASSSeat">Seat</a>. <i>sea</i> represents an object of class <a href="#CLASSSeat">Seat</a>, and <i>sea</i> meets:</p><p>  The attribute <i>SeatId</i> of the object <i>sea</i> is equal to <i>seatid</i></p></td>
    </tr>
    <tr>
<td><b>Preconditions:</b></td>
...
<table>
    ...
    <tr>
        <td><b>Input:</b></td>
<td><p>1. name: <i>accoutId</i>, type: String</p><p>2. name: <i>routeId</i>, type: String</p><p>3. name: <i>seatId</i>, type: String</p><p>4. name: <i>price</i>, type: Real</p><p>5. name: <i>ticketId</i>, type: String</p></td>
</tr>
<tr>
    <td><b>Output Type:</b></td>
    <td>Boolean</td>
...
<tr>
            <td><b>Definition:</b></td>
<td><p>1. <i>route</i> is the object <i>rou</i> in the instance set of class <a href="#CLASSRoute">Route</a>. <i>rou</i> represents an object of class <a href="#CLASSRoute">Route</a>, and <i>rou</i> meets:</p><p>  The attribute <i>RouteId</i> of the object <i>rou</i> is equal to <i>routeId</i></p><p>2. <i>accout</i> is the object <i>acc</i> in the instance set of class <a href="#CLASSAccout">Accout</a>. <i>acc</i> represents an object of class <a href="#CLASSAccout">Accout</a>, and <i>acc</i> meets:</p><p>  The attribute <i>AccoutId</i> of the object <i>acc</i> is equal to <i>accoutId</i></p><p>3. <i>seat</i> is the object <i>sea</i> in the instance set of class <a href="#CLASSSeat">Seat</a>. <i>sea</i> represents an object of class <a href="#CLASSSeat">Seat</a>, and <i>sea</i> meets:</p><p>  The attribute <i>SeatId</i> of the object <i>sea</i> is equal to <i>seatId</i></p><p>4. <i>ticket</i> is the object <i>tic</i> in the instance set of class <a href="#CLASSTicket">Ticket</a>. <i>tic</i> represents an object of class <a href="#CLASSTicket">Ticket</a>, and <i>tic</i> meets:</p><p>  The attribute <i>TicketId</i> of the object <i>tic</i> is equal to <i>ticketId</i></p></td>
    </tr>
    <tr>
<td><b>Preconditions:</b></td>
        <td><p>1. The object <i>route</i> exists</p><p>2. The object <i>accout</i> exists</p><p>3. The object <i>seat</i> exists</p><p>4. The object <i>ticket</i> doesn't exist</p></td>
</tr>
    <tr>
        <td><b>Postconditions:</b></td>
    <td><p>1. <i>tic</i> represented the object of class <a href="#CLASSTicket">Ticket</a></p><p>2. The object <i>tic</i> was created</p><p>3. The attribute <i>TicketId</i> of the object <i>tic</i> became <i>ticketId</i></p><p>4. The attribute <i>RouteId</i> of the object <i>tic</i> became <i>routeId</i></p><p>5. The attribute <i>SeatId</i> of the object <i>tic</i> became <i>seatId</i></p><p>6. The attribute <i>Price</i> of the object <i>tic</i> became <i>price</i></p><p>7. The attribute <i>IsValid</i> of the object <i>tic</i> became <b>false</b></p><p>8. The object <i>tic</i> was put into the instance set of class <a href="#CLASSTicket">Ticket</a></p><p>9. The object <a href="#BuyTicketServiceCurrentTicket">CurrentTicket</a> became <i>tic</i></p><p>10. The value of temporary variable <a href="#BuyTicketServiceCurrentAccoutId">CurrentAccoutId</a> became <i>accoutId</i></p><p>11. The return value was <b>true</b></p></td>
    </tr>
</table>
...
<td><b>Preconditions:</b></td>
    ...
    <tr>
        <td><b>Postconditions:</b></td>
    <td><p>1. The attribute <i>isValid</i> of the object <a href="#BuyTicketServiceCurrentTicket">CurrentTicket</a> became <b>true</b></p><p>2. The attribute <i>OrderStatus</i> of the object <a href="#BuyTicketServiceCurrentOrder">CurrentOrder</a> became <b>PAID</b></p><p>3. The return value was <b>true</b></p></td>
    </tr>
</table>
...
<td><b>Preconditions:</b></td>
    ...
    <tr>
        <td><b>Postconditions:</b></td>
    <td><p>The return value was the set of class <a href="#CLASSRoute">Route</a>, including all <i>route</i> in the instance set of class <a href="#CLASSRoute">Route</a>. <i>route</i> represented an object of class <a href="#CLASSRoute">Route</a>, and <i>route</i> meet:</p><p>  The attribute <i>StartStation</i> of the object <i>route</i> was equal to <i>startStation</i></p><p>  The attribute <i>EndStation</i> of the object <i>route</i> was equal to <i>endStation</i></p><p>  The attribute <i>Time</i> of the object <i>route</i> was equal to <i>time</i></p></td>
    </tr>
</table>
...
<tr>
            <td><b>Definition:</b></td>
<td><p>1. <i>ticket</i> is the object <i>tic</i> in the instance set of class <a href="#CLASSTicket">Ticket</a>. <i>tic</i> represents an object of class <a href="#CLASSTicket">Ticket</a>, and <i>tic</i> meets:</p><p>  The attribute <i>TicketId</i> of the object <i>tic</i> is equal to <i>ticketId</i></p><p>2. <i>accout</i> is the object <i>acc</i> in the instance set of class <a href="#CLASSAccout">Accout</a>. <i>acc</i> represents an object of class <a href="#CLASSAccout">Accout</a>, and <i>acc</i> meets:</p><p>  The attribute <i>AccoutId</i> of the object <i>acc</i> is equal to <i>accoutId</i></p><p>3. <i>order</i> is the object <i>ord</i> in the instance set of class <a href="#CLASSOrder">Order</a>. <i>ord</i> represents an object of class <a href="#CLASSOrder">Order</a>, and <i>ord</i> meets:</p><p>  The attribute <i>TicketId</i> of the object <i>ord</i> is equal to <i>ticketId</i></p><p>  The attribute <i>AccoutId</i> of the object <i>ord</i> is equal to <i>accoutId</i></p><p>  The attribute <i>OrderStatus</i> of the object <i>ord</i> is equal to <b>PAID</b></p></td>
    </tr>
    <tr>
<td><b>Preconditions:</b></td>
...
<td><b>Preconditions:</b></td>
    ...
    <tr>
        <td><b>Postconditions:</b></td>
    <td><p>The return value was the set of class <a href="#CLASSOrder">Order</a>, including all <i>order</i> in the instance set of class <a href="#CLASSOrder">Order</a>. <i>order</i> represented an object of class <a href="#CLASSOrder">Order</a>, and <i>order</i> meet:</p><p>  The attribute <i>AccoutId</i> of the object <i>order</i> was equal to <i>accoutId</i></p></td>
    </tr>
</table>
...
<td><b>Preconditions:</b></td>
    ...
    <tr>
        <td><b>Postconditions:</b></td>
    <td><p>The return value was the set of class <a href="#CLASSOrder">Order</a>, including all <i>order</i> in the instance set of class <a href="#CLASSOrder">Order</a>. <i>order</i> represented an object of class <a href="#CLASSOrder">Order</a>, and <i>order</i> meet:</p><p>  The attribute <i>TicketId</i> of the object <i>order</i> was equal to <i>ticketId</i></p></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td><b>Input:</b></td>
<td><p>1. name: <i>accoutId</i>, type: String</p><p>2. name: <i>ticketId</i>, type: String</p><p>3. name: <i>newRouteId</i>, type: String</p><p>4. name: <i>price</i>, type: Real</p><p>5. name: <i>seatId</i>, type: String</p></td>
</tr>
<tr>
    <td><b>Output Type:</b></td>
    <td>Boolean</td>
...
<tr>
            <td><b>Definition:</b></td>
<td><p>1. <i>ticket</i> is the object <i>tic</i> in the instance set of class <a href="#CLASSTicket">Ticket</a>. <i>tic</i> represents an object of class <a href="#CLASSTicket">Ticket</a>, and <i>tic</i> meets:</p><p>  The attribute <i>TicketId</i> of the object <i>tic</i> is equal to <i>ticketId</i></p><p>  The attribute <i>IsValid</i> of the object <i>tic</i> is equal to <b>true</b></p><p>2. <i>accout</i> is the object <i>acc</i> in the instance set of class <a href="#CLASSAccout">Accout</a>. <i>acc</i> represents an object of class <a href="#CLASSAccout">Accout</a>, and <i>acc</i> meets:</p><p>  The attribute <i>AccoutId</i> of the object <i>acc</i> is equal to <i>accoutId</i></p><p>3. <i>seat</i> is the object <i>sea</i> in the instance set of class <a href="#CLASSSeat">Seat</a>. <i>sea</i> represents an object of class <a href="#CLASSSeat">Seat</a>, and <i>sea</i> meets:</p><p>  The attribute <i>SeatId</i> of the object <i>sea</i> is equal to <i>seatId</i></p><p>4. <i>route</i> is the object <i>rou</i> in the instance set of class <a href="#CLASSRoute">Route</a>. <i>rou</i> represents an object of class <a href="#CLASSRoute">Route</a>, and <i>rou</i> meets:</p><p>  The attribute <i>RouteId</i> of the object <i>rou</i> is equal to <i>newRouteId</i></p><p>5. <i>order</i> is the object <i>ord</i> in the instance set of class <a href="#CLASSOrder">Order</a>. <i>ord</i> represents an object of class <a href="#CLASSOrder">Order</a>, and <i>ord</i> meets:</p><p>  The attribute <i>AccoutId</i> of the object <i>ord</i> is equal to <i>accoutId</i></p><p>  The attribute <i>TicketId</i> of the object <i>ord</i> is equal to <i>ticketId</i></p><p>  The attribute <i>OrderStatus</i> of the object <i>ord</i> is equal to <b>PAID</b></p></td>
    </tr>
    <tr>
<td><b>Preconditions:</b></td>
        <td><p>1. The object <i>ticket</i> exists</p><p>2. The object <i>accout</i> exists</p><p>3. The object <i>route</i> exists</p><p>4. The object <i>seat</i> exists</p><p>5. The object <i>order</i> exists</p></td>
</tr>
    <tr>
        <td><b>Postconditions:</b></td>
    <td><p>1. The attribute <i>RouteId</i> of the object <i>ticket</i> became <i>newRouteId</i></p><p>2. The attribute <i>SeatId</i> of the object <i>ticket</i> became <i>seatId</i></p><p>3. The attribute <i>Price</i> of the object <i>ticket</i> became <i>price</i></p><p>4. The attribute <i>IsValid</i> of the object <i>ticket</i> became <b>false</b></p><p>5. The object <a href="#ModifyTripServiceCurrentTicket">CurrentTicket</a> became <i>ticket</i></p><p>6. The object <a href="#ModifyTripServiceCurrentOrder">CurrentOrder</a> became <i>order</i></p><p>7. The return value was <b>true</b></p></td>
    </tr>
</table>
...
<td><b>Preconditions:</b></td>
    ...
    <tr>
        <td><b>Postconditions:</b></td>
    <td><p>1. The attribute <i>IsValid</i> of the object <a href="#ModifyTripServiceCurrentTicket">CurrentTicket</a> became <b>true</b></p><p>2. The attribute <i>OrderStatus</i> of the object <a href="#ModifyTripServiceCurrentOrder">CurrentOrder</a> became <b>PAID</b></p><p>3. The return value was <b>true</b></p></td>
    </tr>
</table>
...
<td><b>Preconditions:</b></td>
    ...
    <tr>
        <td><b>Postconditions:</b></td>
    <td><p>1. The object <i>ticket</i> was deleted from the instance set of class <a href="#CLASSTicket">Ticket</a></p><p>2. The value of temporary variable <a href="#DeleteOverdueOrderServiceCurrentTicketId">CurrentTicketId</a> became <i>ticketId</i></p><p>3. The return value was <b>true</b></p></td>
    </tr>
</table>
...
<tr>
            <td><b>Definition:</b></td>
<td><p><i>order</i> is the object <i>ord</i> in the instance set of class <a href="#CLASSOrder">Order</a>. <i>ord</i> represents an object of class <a href="#CLASSOrder">Order</a>, and <i>ord</i> meets:</p><p>  The attribute <i>TicketId</i> of the object <i>ord</i> is equal to the value of temporary variable <a href="#DeleteOverdueOrderServiceCurrentTicketId">CurrentTicketId</a></p><p>  The attribute <i>OrderStatus</i> of the object <i>ord</i> is equal to <b>CANCELED</b></p></td>
    </tr>
    <tr>
<td><b>Preconditions:</b></td>
        <td><p>The object <i>order</i> exists</p></td>
