...
public interface CreateTripService {
	...
	boolean check(String accoutId) throws PreconditionException, PostconditionException, ThirdPartyServiceException;
	boolean buyTicket(String routeId, String ticketId) throws PreconditionException, PostconditionException, ThirdPartyServiceException;
